...
<%
	...
	String date = request.getParameter("re_date");
	...
	PrintWriter writer = null;
	   try{
		   String filePath = application.getRealPath("/WEB-INF/repair/"+filename);
	  ...
	  writer.flush();
	   ...
	   response.sendRedirect("repairResult.jsp?send="+result);
